...
// 772. TestScriptExtension
// Tests that the script extender Patch is working properly
// Returns TRUE if test passed
// Undefinied behavior if in fails
int TestScriptExtension( int iTest, float fTest, string sTest);

// 773. OpenFile
// Applies `fopen` semantics to open file
// Returns the FILE * handle as an integer
int OpenFile(string sFilename, string sMode);

// 774. CloseFile
// Runs `fclose` against the FILE * Handler represented by this integer
// Returns TRUE if the file was closed
int CloseFile(int iFileHandle);

// 775. ReadTextFile
// Reads iCount characters from the file into the return string
string ReadTextFile(int iFileHandle, int iCount);
